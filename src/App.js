...
function App() {
  ...
  const pokemons = POKEMONS.map((pokemon) => <PokemonCard key={pokemon.id} {...pokemon}/>);
  ...
  return (
    <>
      ...
      <Layout urlBg={bg1} title="Some title...">
      ...
      <Layout colorBg='red' title='Another title...'>
        <div className="flex">
          {pokemons}
        </div>
      </Layout>
      <Layout urlBg={bg2} title='One more title...'>
